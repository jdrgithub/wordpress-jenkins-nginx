        ...
        sh """
          ...
          docker run --rm --user root \
            ...
            alpine sh -c '
              ...
              find /opt/webapps/envs/prod/wp-content/uploads/elementor -type f -exec sed -i 's|https://dev.nimbledev.io|https://nimbledev.io|g' {} + || echo "No subsitutions needed for dev.nimbledev.io or permissions denied."
            '
